...
) {    // Get user's rubrics (for displaying in reviews or any other purpose)
    // This endpoint will only return rubrics created by the user, regardless of role
    @GetMapping("/user/{userId}")
    fun getRubricsByUser(@PathVariable userId: UUID): ResponseEntity<Any> {
        return try {
